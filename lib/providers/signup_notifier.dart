...
class SignupNotifier extends Notifier<SignupState> {
  ...
  void updateChildName(String value) {
    state = state.copyWith(childName: value);
  }

  void updateParentMobile(String value) {
    state = state.copyWith(parentMobile: value);
  }

  void updateParentEmail(String value) {
    state = state.copyWith(parentEmail: value);
  }
  ...
  void updateClassLevel(int value) {
    state = state.copyWith(classLevel: value);
  }
}
